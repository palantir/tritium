...
abstract class InvocationEventProxy implements InvocationHandler {
    ...
    public final Object invoke(Object proxy, Method method, @Nullable Object @Nullable [] nullableArgs)
            throws Throwable {
        @Nullable Object[] arguments = nullableArgs == null ? EMPTY_ARRAY : nullableArgs;
    ...
    private static boolean isSpecialMethod(Method method, @Nullable Object[] arguments) {
        return isHashCode(method, arguments) || isEquals(method, arguments) || isToString(method, arguments);
    }

    private Object handleSpecialMethod(Object proxy, Method method, @Nullable Object[] arguments) {
    ...
    private static boolean isEquals(Method method, @Nullable Object[] arguments) {
        return arguments.length == 1
                && "equals".equals(method.getName())
                && method.getParameterTypes()[0] == Object.class;
    }

    private static boolean isHashCode(Method method, @Nullable Object[] arguments) {
        return arguments.length == 0 && "hashCode".equals(method.getName());
    }

    private static boolean isToString(Method method, @Nullable Object[] arguments) {
        return arguments.length == 0 && "toString".equals(method.getName());
    }

    @Nullable
    @VisibleForTesting
    final InvocationContext handlePreInvocation(Object instance, Method method, @Nullable Object[] args) {
