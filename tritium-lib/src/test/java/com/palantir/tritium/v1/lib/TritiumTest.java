...
public class TritiumTest {
    ...
    private final TestInterface instrumentedService =
            com.palantir.tritium.Tritium.instrument(TestInterface.class, delegate, metricRegistry);
    private final TestInterface taggedInstrumentedService =
            com.palantir.tritium.Tritium.instrument(TestInterface.class, delegate, taggedMetricRegistry);
    ...
    public void testToString() {
        ...
        assertThat(com.palantir.tritium.Tritium.instrument(TestInterface.class, instrumentedService, metricRegistry)
                        .toString())
    ...
    public void testInaccessibleConstructor() throws NoSuchMethodException {
        Constructor<com.palantir.tritium.v1.lib.Tritium> constructor = Tritium.class.getDeclaredConstructor();
