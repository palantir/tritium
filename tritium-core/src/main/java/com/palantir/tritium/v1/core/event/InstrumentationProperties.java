...
public final class InstrumentationProperties {
    ...
    @SuppressWarnings({"NoFunctionalReturnType", "WeakerAccess"}) // public API
    public static BooleanSupplier getSystemPropertySupplier(Class<?> clazz) {
    ...
    public static BooleanSupplier getSystemPropertySupplier(String name) {
        ...
        boolean instrumentationEnabled = isGloballyEnabled() && isSpecificallyEnabled(name);
        return () -> instrumentationEnabled;
    }

    @SuppressWarnings("WeakerAccess") // public API
    public static boolean isSpecificallyEnabled(String name) {
        return isSpecificallyEnabled(name, true);
    }

    @SuppressWarnings("WeakerAccess") // public API
    public static boolean isSpecificallyEnabled(String name, boolean defaultValue) {
