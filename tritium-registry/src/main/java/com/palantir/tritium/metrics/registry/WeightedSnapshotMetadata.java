...
import com.palantir.tritium.metrics.registry.SampleMetadata;
 ...
 */
public class WeightedSnapshotMetadata extends Snapshot {
    ...
    public WeightedSnapshotMetadata(Collection<WeightedSampleMetadata> values) {
        final WeightedSampleMetadata[] copy = values.toArray(new WeightedSampleMetadata[]{});
        ...
        double sumWeight = 0;
        for (WeightedSampleMetadata sample : copy) {
