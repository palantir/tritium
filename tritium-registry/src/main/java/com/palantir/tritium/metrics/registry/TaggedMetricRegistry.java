...
public interface TaggedMetricRegistry extends TaggedMetricSet {
     ...
     * @param gauge gauge
     * @return gauge metric
     *     <p>In most cases, one typically wants {@link #registerWithReplacement(MetricName, Gauge)} as gauges may
    ...
    /**
     * Adds a set of metrics to this TaggedMetricRegistry's metric set, which are to be uniquely identified by the tags
     * provided.
     *
     * <p>So, if I have a metric registry with a single metric called 'foo', and I add it with tag (bar, baz), this
     * registry will now contain 'foo', tagged with (bar, baz).
     *
     * <p>If a metric exists with duplicate tags, then calling {@link TaggedMetricSet#getMetrics} will be impossible.
     *
     ...
     * set.
     *
     * <p>The value is removed only when {@link Object#equals} for the values returns true, therefore you should
     * generally provide the same instance as a previous call to addMetrics.
     *
