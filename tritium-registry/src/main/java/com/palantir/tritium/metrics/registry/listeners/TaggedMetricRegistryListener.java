 ...
 */
public interface TaggedMetricRegistryListener {
    /**
     * A no-op implementation of {@link TaggedMetricRegistryListener}.
     */
    abstract class Base implements TaggedMetricRegistryListener {
        @Override
